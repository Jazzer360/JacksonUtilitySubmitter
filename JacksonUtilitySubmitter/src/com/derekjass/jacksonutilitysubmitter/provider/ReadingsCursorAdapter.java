...
public class ReadingsCursorAdapter extends CursorAdapter {
	...
	public View newView(Context context, Cursor cursor, ViewGroup parent) {
		...
		views.electricViews = (View) newView.findViewById(R.id.electricViews);
		views.waterViews = (View) newView.findViewById(R.id.waterViews);
		views.gasViews = (View) newView.findViewById(R.id.gasViews);
		views.electricText =
